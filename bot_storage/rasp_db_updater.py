...
def export_xlsx_to_db(xlsx_file):
    # speed test
    ...
    # await bot.send_message(user_id, f"На запись в базу данных ушло {db_processing_time} секунд")
    # await bot.send_message(user_id, f"Всего затрачено {total_processing_time} секунд")
