...
from bot_storage.Keyboards import rasp_by_days_kb, secret_role_kb, cancel_kb
...
async def pupils_rasp(message: types.Message):
    ...
    # pupils_rasp.PupilsRaspReqStates.waiting_for_action = MasterStates.waiting_for_action
